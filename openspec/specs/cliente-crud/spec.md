...
Define o comportamento do modulo de Clientes: paginas de listagem, criacao, edicao e remocao de clientes com dados mock, usando os inputs adequados do Ant Design para cada campo (Nome, CPF/CNPJ, Email e Telefone).
